    ...
    var getForm = function getForm(store) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'gx-holder', 'data-form-error': 'gx-pin' },
            _react2.default.createElement(
              'label',
              { htmlFor: 'gx-number' },
              'GX Number',
              _react2.default.createElement('input', { name: 'gx-number', id: 'gx-number', type: 'text' })
            ),
            _react2.default.createElement(_formError2.default, { forInput: 'gx-number' }),
            _react2.default.createElement(
              'label',
              { id: 'gx-pin-abel', htmlFor: 'gx-pin' },
              'GX Pin',
              _react2.default.createElement('input', { name: 'gx-pin', id: 'gx-pin', type: 'text' })
            ),
      ...
      describe('On Submit', function () {
        describe('This event is triggered when the form is submitted by the user', function () {
          describe('WHEN error is present', function () {
            ...
            it('SHOULD execute validate and invalidate events', function () {
              wrapper.find('#gx-pin').simulate('change', { target: { value: '12345' } }).simulate('blur', { target: { value: '12345' } }).simulate('change', { target: { value: '1' } }).simulate('blur', { target: { value: '1' } });
              /*
            ...
            describe('AND error is removed', function () {
              ...
              it('SHOULD remove error input class', function () {
                expect(wrapper.find('#gx-number').hasClass(CONST.ERROR_INPUT_CLASS_NAME)).toBe(false);
              });
      ...
      describe('On Validate', function () {
        describe('This event is triggered ON BLUR', function () {
          describe('WHEN error is present', function () {
            ...
            it('SHOULD add error class to a data-form-error element', function () {
              expect(wrapper.find('#gx-holder').hasClass(CONST.ERROR_INPUT_CLASS_NAME)).toBe(true);
            });

            it('SHOULD add error class to input element label', function () {
