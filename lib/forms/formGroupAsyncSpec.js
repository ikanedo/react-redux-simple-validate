  ...
  describe('Use this if you have multiple form groups\n    AND you want to submit the form only WHEN all groups are valid', function () {
    ...
    describe('Utility methods', function () {
      ...
      describe('setGroups', function () {
        it('SHOULD set formGroups promises', function () {
        ...
        it('SHOULD throw an error if not string', function () {
          expect(formGroupAsync.setGroups.bind(formGroupAsync, 'newGroup')).toThrowAnyError();
        });
      });

      describe('addGroup', function () {
        it('SHOULD add formGroup name', function () {
          expect(formGroupAsync.groups).toEqual(jasmine.arrayContaining(['personal', 'address']));
      ...
      describe('then - success callback method', function () {
        describe('single call back only', function () {
          it('SHOULD call the last then method only', function (done) {
    ...
    describe('fail - error callback method', function () {
      describe('single call back only', function () {
        it('SHOULD call the last fail method only', function (done) {
