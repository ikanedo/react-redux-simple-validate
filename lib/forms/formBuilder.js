...
function getFormElProps(element, formGroupProps) {
  var _element$props = element.props,
      ...
      onBlurProp = _element$props.onBlur,
  ...
  if (stringRefs && element.props && element.props.value && formElementValue != null && stringRefs[(0, _formElementUtils.getFormElementRefName)(element) + '-value'] && element.props.value !== stringRefs[(0, _formElementUtils.getFormElementRefName)(element) + '-value'] && element.props.value !== formElementValue.value) {
  ...
  var onBlurEvents = mergeCallbacks(getValidateEvents('onBlur', formGroupProps));

  return _extends({}, element.props, {
    key: name,
    ref: function ref(node) {
      stringRefs[(0, _formElementUtils.getFormElementRefName)(element)] = node;
      stringRefs[(0, _formElementUtils.getFormElementRefName)(element) + '-value'] = element.props.value;
    },
